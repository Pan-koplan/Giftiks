            ...
            <div class="container">
                ...
                <div class="carousel">
                    <div class="carousel-thumbs">
                        ...
                        @foreach ($photos as $index => $photo)
                            <img src="{{ Storage::url($photo) }}" onclick="changeImage('{{ Storage::url($photo) }}')"
                                alt="{{ $gift->name }}" data-index="{{ $indexx }}">
                            @php
                                $indexx += 1; // Увеличение без вывода
                            @endphp
                        @endforeach
                    </div>
                    <img id="mainImage" src='{{ Storage::url($photos[0]) }}' onclick="changeMainImage()" class="main-image"
                ...
                <div class="product-info">
                    ...
                    <div class="buttons_mobile">
                        <button class="button"><svg height="512" viewBox="0 0 512 512" width="512"
                        ...
                        <button class="button"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <title />
                                <path
                        ...
                        <button class="button"><svg height="512px" style="enable-background:new 0 0 512 512;" version="1.1"
