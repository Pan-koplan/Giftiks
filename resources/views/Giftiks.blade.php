            ...
            <div class="mobile">
                <div class="title_objects"
                    ...
                    <div id="title_form">
                        ...
                        <textarea id="autoExpand" class="textarea" oninput="autoResize(this)" type="text"
                            placeholder="Обожает апельсиновый, слушает рэгги и работает сварщиком"></textarea>
                        ...
                        <div class="right_grid">
                            <div class="title_right_bar">
                                ...
                                <form action="{{ route('YATAG') }}" method="POST">
                                    @csrf
                                    <textarea id="autoExpand" class="textarea" type="text" name="descript_prompt"
                                        placeholder="Обожает апельсиновый, слушает рэгги и работает сварщиком"></textarea>
